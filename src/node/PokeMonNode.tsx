import type {
  ...
  function convertImageElement(domNode: Node): null | DOMConversionOutput {
    if (domNode instanceof HTMLImageElement) {
      ...
      const node = $createPokeMonNode({ altText, src });
      return { node };
    }
    return null;
  }
  ...
  export function $createPokeMonNode({
    altText,
    height,
    maxWidth = 500,
    captionsEnabled,
